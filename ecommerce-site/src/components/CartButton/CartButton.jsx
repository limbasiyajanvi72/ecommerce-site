...
function CartButton({
	...
	return (
		<div>
			...
			<div>
				<button
					className='border-2 rounded-l-md border-slate-950 bg-slate-950 text-slate-400 w-4'
				...
				<input
					type='number'
					className='w-4 hover:border-0 focus:border-0 text-base font-medium text-center bg-slate-900 text-slate-400'
					value={productCount}
					style={{
						WebkitAppearance: "textfield",
						margin: 0,
						borderTop: "2px solid rgb(2 6 23)",
						borderBottom: "2px solid rgb(2 6 23)",
					}}
				...
				<button
					className='border-2 rounded-r-md border-slate-950 w-4  bg-slate-950 text-slate-400'
